...
const AdminNavbar = () => {
  return (
    <>
      ...
      <div
        id="sidebar"
        class="bg-white border border-4  h-screen md:block shadow-xl px-3 w-30 md:w-60 lg:w-60 overflow-x-hidden transition-transform duration-300 ease-in-out"
        x-show="sidenav"
      ...
      >
        <div class="space-y-6 md:space-y-10 mt-10">
          ...
          <h1 class="hidden md:block font-bold text-sm md:text-xl text-center">
            Kajogari logo<span class="text-teal-600">.</span>
          </h1>
          ...
          <div id="menu" class="flex flex-col space-y-2">
            <a
              href=""
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-red-500 hover:text-white hover:text-base rounded-md transition duration-150 ease-in-out"
            >
             <DashboardIcon/>
              <span class="ml-5">Dashboard</span>
            </a>
            <a
              href="/Admin/ProductContent"
            ...
            >
             <ProductionQuantityLimitsIcon/>
              <span class="ml-5">Products Content</span>
            </a>
            <a
              href="/Admin/BannerContent"
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-red-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
            >
          <ViewCarouselIcon/>
              <span class="ml-5">Banner Content</span>
            </a>
            <a
              href=""
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-red-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
            >
           <CategoryIcon/>
              <span class="ml-5">Category Content</span>
            </a>
            <a
              href=""
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-red-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
            >
              ...
              <span class="ml-2">Sub Contegory Content</span>
            </a>
            {/* <a
              href=""
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-red-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
