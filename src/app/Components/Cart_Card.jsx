                        ...
                        <tr>
                            <td className="py-4">
                                <div className="flex items-center">
                                    <Image width={100} height={100} className="h-16 w-16 mr-4" src={cartItems.product_Img[0].product_Img} alt="Product image" />
                                    <span className="font-semibold">{cartItems.product_name}</span>
                                </div>
                            </td>
                            <td className="py-4">$ {cartItems.Online_price }</td>
                            <td className="py-4">
                                <div className="flex items-center">
                            ...
                            <td className="py-4">$ {cartItems.Online_price *  cartItems.quantity}</td>
                            <td>
